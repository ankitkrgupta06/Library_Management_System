...
const issueSchema=new mongoose.Schema({
  ...
  fineInterval:{type:String,default:"day"},
  manualFine:{type:Number,default:0},
  fineCleared:{type:Boolean,default:false},
  clearedFineAmount:{type:Number,default:0},
...
const Issue=mongooose.model("Issue",issueSchema);
